...
import { GST, GCATS1 } from '@/lib/constants';
import GoalCard from '../GoalCard';
import GoalModal from '../GoalModal';

export default function W1Goals({w1,setW1}){
  const {goals,tasks}=w1;
  const setGoals=fn=>setW1(d=>({...d,goals:typeof fn==="function"?fn(d.goals):fn}));
  ...
  return(
    <div>
      ...
      <GoalModal open={!!modal} onClose={()=>setModal(null)} initial={modal&&modal!=="new"?goals.find(g=>g.id===modal):null} cats={GCATS1}

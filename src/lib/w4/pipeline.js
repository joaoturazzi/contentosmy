...
function buildHTMLShell(blueprint, plan, scraped, vibe) {
  ...
  // AI-generated hero image takes priority over scraped images
  const heroImage = scraped.aiHeroImage || (scraped.images || []).find(i => i && (/header|hero|banner|desk|main/i.test(i))) || realImages[0] || null;
...
${shell.heroImage
    ? `Usar esta imagem${scraped.aiHeroImage ? ' GERADA POR IA' : ' real do site'} no hero:
